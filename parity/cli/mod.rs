...
usage! {
	...
	}
	{
		...
		CMD cmd_wallet: bool
		{
			...
			{
				ARG arg_wallet_import_path: Vec<String>, |arg: Arg| arg.required(true).index(3), // setting it to Vec<String> so that it's the same everywhere
		...
		CMD cmd_dapp: bool
		{
			ARG arg_dapp_path: Vec<String>, |arg: Arg| arg.index(2).required(true),
		}
